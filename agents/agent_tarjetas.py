...
def compatibility(pregunta: str) -> float:
    concepto = "Quiero información los tipos de tarjeta disponibles para poder adquirir alguna (Crédito, Débido, Visa, Mastercard)"
